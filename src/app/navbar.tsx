          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div className="relative ml-3">
              ...
              {profileDropdownOpen && (
                ...
                >
                  <Link href="https://www.linkedin.com/in/fatima-nazeer-493a83278/" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" id="user-menu-item-0">
                    My Profile
                  </Link>
                  <Link href="https://my-profile-website-one.vercel.app/" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" id="user-menu-item-2">
                    Portfolio
                  </Link>
                </div>
              )}
